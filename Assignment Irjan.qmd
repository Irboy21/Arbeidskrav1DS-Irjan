...
In recent year their has been an "crisis" in many academic fields due to concerts many study's might present false findings @ioannidis2005b. This paper will discuss whether or not reproducibility is enough for publications too be viewed as valid, or replicability needs to be the standard.
...
And it is important that all software and used version used is clearly specified @gentleman2005b. Robert Gentleman argues that if these aspect are not properly documented, the thought of reproduce an original experiment almost imposible.
In order for
