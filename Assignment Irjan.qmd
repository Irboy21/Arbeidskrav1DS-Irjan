...
In fields where this is the case, findings that are part of the foundation of the practice can be based on false claims.
...
Reproducibility is when results of a study, can be found again if the same tests are run from the same data sample that the original study used.
Replicability on the other hand is when the same resaults can be found from a different population.
